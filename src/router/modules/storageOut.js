  ...
  children: [
    {
      path: 'list-out',
      name: 'ListOut',
      component: () => import('@/views/storageOut/components/ListOut.vue'),
      meta: { title: '出库单', icon: 'table' }
    },
    {
      path: 'task-picking',
      name: 'TaskPicking',
      component: () => import('@/views/storageOut/components/TaskPicking.vue'),
      meta: { title: '拣货任务', icon: 'table' }
    },
    {
      path: 'manage-task-transfer',
      name: 'TaskTransfer',
      component: () => import('@/views/storageOut/components/TaskTransfer.vue'),
